#!/usr/bin/env python3
"""Opt-in native Cursor worker -> scripted OpenCode-contract parent workflow.
Uses live Cursor credentials and real OMAR MCP/spawn/scheduler/ack/retirement.
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='omar-live-workflow-', dir='/tmp') as directory:
        ...
        try:
            ...
            print('PASS: live Cursor worker completed through OMAR MCP; host woke scripted OpenCode parent; result read, acknowledged, retired and project settled', flush=True)
        finally:
